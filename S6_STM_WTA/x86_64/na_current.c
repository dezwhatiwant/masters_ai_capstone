...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na /content/gdrive/MyDrive/Colab Notebooks/S6_STM_WTA/na_current.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/content/gdrive/MyDrive/Colab Notebooks/S6_STM_WTA/na_current.mod";
static const char* nmodl_file_text = 
