...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 GABA /content/gdrive/MyDrive/Colab Notebooks/S6_STM_WTA/GABA_syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/content/gdrive/MyDrive/Colab Notebooks/S6_STM_WTA/GABA_syn.mod";
static const char* nmodl_file_text = 
